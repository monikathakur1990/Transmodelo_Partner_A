package com.transmodelo.conductor.common.fcm;
...
import com.transmodelo.conductor.common.fcm.popup.NotificationDialog;
...
//            if ((message.equalsIgnoreCase("Nuevo viaje entrante") || message.contains("RRRR"))
//                    && isBackground(getApplicationContext())
//                    && (!isLocked(getApplicationContext()) || isLocked(getApplicationContext()) )
