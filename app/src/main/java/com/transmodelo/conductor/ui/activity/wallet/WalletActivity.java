...
import com.transmodelo.conductor.ui.activity.payment.PaymentActivity;
import com.transmodelo.conductor.ui.activity.request_money.RequestMoneyActivity;
import com.transmodelo.conductor.ui.adapter.WalletAdapter;
...
import static com.transmodelo.conductor.ui.activity.payment.PaymentActivity.PICK_PAYMENT_METHOD;
...
public class WalletActivity extends BaseActivity implements WalletIView {
    ...
    public void onSuccess(WalletResponse response) {
        ...
        tvWalletAmt.setText(String.format("%s %.2f", Constants.Currency, walletAmt));
