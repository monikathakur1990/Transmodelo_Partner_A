...
import static com.transmodelo.conductor.MvpApplication.DATUM;
import static com.transmodelo.conductor.MvpApplication.DEFAULT_ZOOM;
import static com.transmodelo.conductor.MvpApplication.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.transmodelo.conductor.MvpApplication.canGoToChatScreen;
import static com.transmodelo.conductor.MvpApplication.isChatScreenOpen;
...
import com.transmodelo.conductor.common.ChatHeadService;
import com.transmodelo.conductor.common.Constants;
import com.transmodelo.conductor.common.GPSTracker;
import com.transmodelo.conductor.common.LocaleHelper;
import com.transmodelo.conductor.common.PolyUtil;
import com.transmodelo.conductor.common.SharedHelper;
import com.transmodelo.conductor.common.Utilities;
import com.transmodelo.conductor.common.chat.ChatActivity;
...
import com.transmodelo.conductor.data.network.model.LatLngFireBaseDB;
...
import com.transmodelo.conductor.ui.activity.document.DocumentActivity;
import com.transmodelo.conductor.ui.activity.earnings.EarningsActivity;
import com.transmodelo.conductor.ui.activity.help.HelpActivity;
import com.transmodelo.conductor.ui.activity.instant_ride.InstantRideActivity;
import com.transmodelo.conductor.ui.activity.invite.InviteActivity;
import com.transmodelo.conductor.ui.activity.invite_friend.InviteFriendActivity;
import com.transmodelo.conductor.ui.activity.notification_manager.NotificationManagerActivity;
import com.transmodelo.conductor.ui.activity.profile.ProfileActivity;
import com.transmodelo.conductor.ui.activity.setting.SettingsActivity;
import com.transmodelo.conductor.ui.activity.summary.SummaryActivity;
import com.transmodelo.conductor.ui.activity.wallet.WalletActivity;
import com.transmodelo.conductor.ui.activity.your_trips.YourTripActivity;
import com.transmodelo.conductor.ui.bottomsheetdialog.invoice_flow.InvoiceDialogFragment;
import com.transmodelo.conductor.ui.bottomsheetdialog.rating.RatingDialogFragment;
import com.transmodelo.conductor.ui.fragment.incoming_request.IncomingRequestFragment;
import com.transmodelo.conductor.ui.fragment.offline.OfflineFragment;
import com.transmodelo.conductor.ui.fragment.status_flow.StatusFlowFragment;
...
public class MainActivity extends BaseActivity implements
        ...
        try {
            ...
            r = () -> {
                if (mLastKnownLocation != null) {
                    ...
                    if(DATUM.getStatus().equals(Constants.checkStatus.STARTED) || DATUM.getStatus().equals(Constants.checkStatus.ARRIVED)
                            || DATUM.getStatus().equals(Constants.checkStatus.PICKEDUP))
                    if (canMapAnimate % 3 == 0) {

                        Log.e("MainActivity", "startCheckStatusCall: DATUM.getStatus(): " + DATUM.getStatus());
    ...
    public void getLocationPermission() {
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) mLocationPermissionGranted = true;
        else
            ...
            if (mLocationPermissionGranted) {
                ...
                locationResult.addOnCompleteListener(this, task -> {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        Log.i(TAG, "getDeviceLocation: moveCamera: mLastKnownLocation.getLatitude: "+mLastKnownLocation.getLatitude());
                        Log.i(TAG, "getDeviceLocation: moveCamera: mLastKnownLocation.getLongitude: "+mLastKnownLocation.getLongitude());
                        ...
                        Log.i(TAG, "getDeviceLocation: Current location is null. Using defaults: "+task.getException());
    ...
    public void onSuccess(TripResponse response) {
        Log.i(TAG, "onSuccess: TripResponse: "+response.toString());
...
//                imgStatus.setImageResource(R.drawable.banner_waiting);w
        ...
        if (response.getRequests().isEmpty()) {
            ...
            Log.i(TAG, "onSuccess: if response.getRequests().isEmpty()");
            ...
            Log.i("MainActivity", "onSuccess: response.getRequests().get(0).getTimeLeftToRespond(): "+response.getRequests().get(0).getTimeLeftToRespond());
    ...
    public void changeFlow(String status) {
        ...
        Log.e(TAG, "changeFlow: status: "+status);
...
//        STATUS = "";
    ...
    private void updateDriverNavigation() {
        Log.i(TAG, "updateDriverNavigation: ");
    ...
    public void onDirectionSuccess(Direction direction, String rawBody) {
        if (direction.isOK()) {
            ...
            if (!route.getLegList().isEmpty()) {
                ...
                Log.i(TAG, "onDirectionSuccess: origin: "+origin+" destination: "+destination);

                srcMarker = googleMap.addMarker(new MarkerOptions()
                        .position(origin)
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.car_icon)));

                Log.i(TAG, "onDirectionSuccess: srcMarker addMarker at origin: "+origin);
                ...
                Log.i(TAG, "onDirectionSuccess: googleMap addMarker at destination: "+destination);

            }

            polyLinePoints = route.getLegList().get(0).getDirectionPoint();

            mPolyline = googleMap.addPolyline(DirectionConverter.createPolyline(this, polyLinePoints, 2, getResources().getColor(R.color.colorAccent)));
    ...
    public void navigateToShareScreen() {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Hola Mira esta aplicación," +
