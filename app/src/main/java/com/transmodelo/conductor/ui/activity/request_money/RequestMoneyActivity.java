...
import com.transmodelo.conductor.data.network.model.RequestedDataItem;
import com.transmodelo.conductor.ui.adapter.RequestAmtAdapter;
...
public class RequestMoneyActivity extends BaseActivity implements RequestMoneyIView {
    ...
    public void onViewClicked() {
        if (TextUtils.isEmpty(etRequestAmt.getText())) {
            ...
            Toast.makeText(this, R.string.insuffecent_amount, Toast.LENGTH_SHORT).show();
            etRequestAmt.setText(null);
