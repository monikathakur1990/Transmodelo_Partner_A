...
import com.transmodelo.conductor.common.RecyclerItemClickListener;
...
import com.transmodelo.conductor.ui.adapter.PlacesAutoCompleteAdapter;
...
public class InstantRideActivity extends BaseActivity
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.qr_scan:
                ...
                intentIntegrator.setPrompt("Escanea el código QR del cliente para realizar el traslado");
    ...
    public void onSuccess(Object response) {
        ...
        try {
            JSONObject jsonObj = new JSONObject(new Gson().toJson(response));
    ...
    private void showConfirmationDialog(double estimatedFare, Map<String, Object> params) {
        ...
        view.findViewById(R.id.tvSubmit).setOnClickListener(view1 -> {
            showLoading();
            Log.e("showConflog: ", params.toString());
    ...
    private void getUserCountryInfo() {
        ...
        tvCountryCode.setText("+591");
        countryCode = "+591";//country.getDialCode();
        countryFlag = "BO";//country.getCode();
    }
